...
class User
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=WorkEntry::class, mappedBy="users_id")
     */
    private $work_entries;

    public function __construct()
    {
        $this->work_entries = new ArrayCollection();
    }
    ...
    {
        return $this->work_entries;
    }

    public function addWorkEntry(WorkEntry $workEntry): self
    {
        if (!$this->work_entries->contains($workEntry)) {
            $this->work_entries[] = $workEntry;
    ...
    {
        if ($this->work_entries->removeElement($workEntry)) {
